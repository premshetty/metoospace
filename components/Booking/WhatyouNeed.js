  ...
  return (
    <div className="mt-5  h-auto w-full rounded-[17px] border-[1px] border-[#80808070] bg-blue-50 py-8 px-5 shadow-md">
      ...
      <textarea
        ...
        className="mt-3 ml-2 hidden h-28 w-full flex-shrink items-center rounded-md border-[1px] border-[#80808070] p-3 text-sm font-bold text-gray-600 placeholder-gray-500  shadow-md outline-none md:inline-flex"
      ></textarea>
    </div>
  )
}
